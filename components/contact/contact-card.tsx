      ...
      <div className="relative overflow-hidden rounded-[1.75rem] border border-warm-border bg-[#FFFDF9] shadow-[0_18px_55px_rgba(47,33,24,0.075)]">
        ...
        <div className="relative flex h-full flex-col justify-between p-5 sm:p-6">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-soft-brown">
              Ask us about product details, sizing, color, availability,
              delivery charges, payment, or your order before purchasing.
            </p>
          </div>

          <div className="mt-5">
            <p className="text-[11px] font-medium tracking-[0.14em] text-muted-gold uppercase">
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex h-11 items-center justify-center gap-3 rounded-full bg-[#3F2A20] px-6 text-xs font-semibold tracking-[0.18em] !text-[#FFFDF9] uppercase shadow-[0_14px_30px_rgba(63,42,32,0.16)] transition hover:bg-[#5B4435]"
              >
                Message on Facebook
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex h-11 items-center justify-center rounded-full border border-warm-border bg-white/45 px-6 text-xs font-semibold tracking-[0.18em] text-deep-brown uppercase transition hover:border-muted-gold hover:text-muted-gold"
              >
                Visit Facebook Page
              </a>
            </div>
...
function ContactInfoCard({
  ...
  return (
    <a
      ...
      className="group relative flex h-full overflow-hidden rounded-[1.5rem] border border-warm-border bg-[#FFFDF9] shadow-[0_14px_42px_rgba(47,33,24,0.055)] transition duration-300 hover:-translate-y-0.5 hover:border-muted-gold"
    >
