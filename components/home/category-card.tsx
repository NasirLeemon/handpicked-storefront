    ...
    <Link href={href} className="group block h-full">
      <article className="relative h-full overflow-hidden rounded-[2rem] border border-warm-border bg-light-sand shadow-sm transition duration-500 hover:-translate-y-1 hover:border-muted-gold hover:shadow-[0_24px_70px_rgba(47,33,24,0.12)]">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#21160F]/20 via-transparent to-transparent" />

          <div className="absolute left-5 top-5 rounded-full border border-warm-border bg-[#FFFDF9]/90 px-4 py-2 shadow-sm backdrop-blur-md">
            <p className="text-[10px] font-semibold tracking-[0.22em] text-deep-brown uppercase">
              {label}
            </p>
          </div>

          <div className="absolute right-5 top-5 flex h-10 w-10 items-center justify-center rounded-full border border-warm-border bg-[#FFFDF9]/90 text-deep-brown opacity-0 shadow-sm backdrop-blur-md transition duration-500 group-hover:opacity-100">
            <ArrowUpRight className="h-4 w-4" strokeWidth={1.7} />
          </div>

          <div className="absolute inset-x-0 bottom-0">
            <div className="bg-gradient-to-t from-[#21160F]/72 via-[#21160F]/30 to-transparent px-5 pb-5 pt-16 lg:px-6 lg:pb-6">
              <div className="max-w-md">
                ...
                <p
                  className={
                    featured
                      ? "mt-3 max-w-md text-sm leading-6 text-[#FFFDF9]/90 lg:leading-7"
                ...
                <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-white/24 bg-white/10 px-3 py-2 text-[10px] font-semibold tracking-[0.2em] text-[#FFF3D6] uppercase backdrop-blur-sm transition duration-500 group-hover:border-white/40 group-hover:bg-white/16">
                  <span>Explore</span>
