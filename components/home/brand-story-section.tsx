...
export function BrandStorySection() {
  return (
    <section className="bg-ivory px-4 py-9 sm:px-6 lg:px-8">
          ...
          <div className="relative flex flex-col gap-4 px-5 py-5 sm:px-7 md:flex-row md:items-center md:justify-between">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h2 className="mt-2 max-w-2xl font-serif-brand text-4xl font-medium leading-tight tracking-[-0.045em] text-deep-brown sm:text-5xl">
