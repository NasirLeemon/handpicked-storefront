...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-[9999] border-b border-warm-border bg-ivory/94 backdrop-blur-xl">
      ...
      <div className="relative mx-auto grid h-14 max-w-7xl grid-cols-[40px_1fr_auto] items-center gap-2 px-4 sm:px-6 md:flex md:h-16 md:justify-between lg:px-8">
        ...
        >
          <span className="block truncate font-serif-brand text-[1.9rem] font-medium leading-none tracking-[-0.045em] text-deep-brown sm:text-4xl md:text-[2rem]">
            Handpicked
          </span>
        </Link>
        ...
        <div className="flex items-center justify-end gap-2 md:flex-1">
          <Link
            href="/cart"
            className="relative inline-flex h-9 w-9 items-center justify-center rounded-full border border-warm-border/80 bg-[#FFFDF9]/70 text-deep-brown shadow-[0_8px_22px_rgba(47,33,24,0.045)] transition hover:border-muted-gold hover:bg-[#FFFDF9]/85 hover:text-muted-gold md:h-10 md:w-auto md:gap-2 md:px-4"
          ...
          <AccountNavLink className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-warm-border/80 bg-[#FFFDF9]/70 text-deep-brown shadow-[0_8px_22px_rgba(47,33,24,0.045)] transition hover:border-muted-gold hover:bg-[#FFFDF9]/85 hover:text-muted-gold md:h-10 md:w-auto md:gap-2 md:px-4 md:text-[11px] md:font-semibold md:tracking-[0.18em] md:uppercase" />
        </div>
      </div>
    </header>
  );
